      ...
      <div className='grid grid-cols-2 gap-5 w-full h-[30vh]'>
        ...
        <div className="flex flex-col justify-between bg-white shadow-md rounded-lg p-4 w-full border border-yellowGreen1 border-opacity-40">
          ...
          <div className="flex flex-col space-y-4 w-full">
            {['Dépôt', 'E-learning', 'Article', 'Evènement', 'Message', 'Response'].map((notification) => (
              <RadioButton
                key={notification}
                id={notification}
                label={`${notification.replace(/([A-Z])/g, ' $1')}`}
        ...
        <div className="flex flex-col justify-between bg-white shadow-md rounded-lg p-4 w-full border border-yellowGreen1 border-opacity-40 ">
          <div>
            ...
            <p className="text-sm text-gray-500">Sélectionnez les données que les autres utilisateurs pourront voir.</p>
          </div>
